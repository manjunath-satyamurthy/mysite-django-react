...
/* all exports used */
/*!*********************************************!*\
  !*** ./anotherapp/react/js/Technologies.js ***!
  \*********************************************/
...
var _jsxFileName = "/home/manju/mysite-django-react/app/anotherapp/react/js/Technologies.js";
...
var Technologies = function (_Component) {
	...
	_createClass(Technologies, [{
		...
		value: function render() {
			...
			if (!this.state.shouldPageLoad) {
				return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_reactRoot_Components__["e" /* InfoTable */], { theaders: header, tbody: body, __source: {
						fileName: _jsxFileName,
						lineNumber: 65
					},
					__self: this
